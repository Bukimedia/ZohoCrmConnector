...
namespace ZohoCrmConnector.Factories
{
    public class ContactsFactory : RestSharpFactory
    {
        ...
        /// <param name="ContactId">Specify unique ID of the record</param>
        /// <param name="parameters">
        /// Dictionary:                 key: newFormat	        value: (1 or 2)	newFormat=1: To exclude fields with "null" values while fetching data from your CRM Contact.
        ///                             key: version            value: (1 -4 Default value: 1)</param>
        /// <returns></returns>
        ...
        /// </summary>
        /// <param name="listContacts">List of Contacts, even if it has only one element</param>
        ...
        /// <returns>List of Contacts</returns>
        public List<Contacts> getSearchRecords(string selectColumns, string searchCondition)
        {
            return this.getSearchRecords<List<Contacts>>(module, selectColumns, searchCondition);
        }
        ...
        ///                             key: version            value: (1 -4 Default value: 1)</param>
        /// <returns>List of Contacts</returns>
        public List<Contacts> getSearchRecords(string selectColumns, string searchCondition, Dictionary<string, string> parameters)
        {
            return this.getSearchRecords<List<Contacts>>(module, selectColumns, searchCondition, parameters);
        }
        ...
        /// <returns>List of Contacts</returns>
        public List<Contacts> getSearchRecordsByPDC(string selectColumns, string searchColumn, string searchValue)
        {
            return this.getSearchRecordsByPDC<List<Contacts>>(module, selectColumns, searchColumn, searchValue);
        }
        ...
        ///                             key: version            value: (1 -4 Default value: 1)</param>
        /// <returns>List of Contacts</returns>
        public List<Contacts> getSearchRecordsByPDC(string selectColumns, string searchColumn, string searchValue, Dictionary<string, string> parameters)
        {
            return this.getSearchRecordsByPDC<List<Contacts>>(module, selectColumns, searchColumn, searchValue, parameters);
        }
        ...
        /// Dictionary:                 key: fromIndex, 	    value: (Default value: 1)
        ///                             key: toIndex,           value: (Default value:20 / Maximum value:200)
        ///                             key: newFormat	        value: (1 or 2)	newFormat=1: To exclude fields with "null" values while fetching data from your CRM Contact.</param>
        /// <returns>List of Contacts</returns>
        ...
        /// <summary>
        /// To download the photo of a contact or Contact
        /// </summary>
        /// <param name="ContactId">Specify unique ID of the record</param>
        ...
        /// <summary>
        /// To delete a photo of a contact or Contact
        /// </summary>
        /// <param name="ContactId">Specify unique ID of the record</param>
