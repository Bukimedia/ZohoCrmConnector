...
namespace ZohoCrmConnector.Factories
{
    public class PotentialsFactory : RestSharpFactory
    {
        ...
        public bool updateRecords(long PotentialId, List<Potentials> listPotentials)
        {
            return this.updateRecords(module, PotentialId, listPotentials);
        }

        public bool updateRecords(long PotentialId, List<Potentials> listPotentials, Dictionary<string, string> parameters)
        {
        ...
        public bool uploadPhoto(long PotentialId, string filePath)
        {
            return this.uploadPhoto(module, PotentialId, filePath);
        }

        public bool downloadPhoto(long PotentialId)
        {
            return this.downloadPhoto(module, PotentialId);
        }

        public bool deletePhoto(long PotentialId)
        {
            return this.deletePhoto(module, PotentialId);
        }
    }
}
