...
namespace ZohoCrmConnector.Factories
{
    public class PotentialsFactory : RestSharpFactory
    {
        ...
        /// </summary>
        /// <returns>List of Potentials</returns>
        ...
        ///                             key: newFormat	        value: (1 or 2)	newFormat=1: To exclude fields with "null" values while fetching data from your CRM Potential.
        ...
        /// </summary>
        /// <param name="PotentialId">Specify unique ID of the record</param>
        ...
        /// <param name="PotentialId">Specify unique ID of the record</param>
        /// <param name="parameters">
        /// Dictionary:                 key: newFormat	        value: (1 or 2)	newFormat=1: To exclude fields with "null" values while fetching data from your CRM Potential.
        ///                             key: version            value: (1 -4 Default value: 1)</param>
        /// <returns></returns>
        ...
        /// </summary>
        /// <param name="listPotentials">List of Potentials, even if it has only one element</param>
        ...
        /// <param name="listPotentials">List of Potentials, even if it has only one element</param>
        /// <param name="parameters">
        /// Dictionary:                 key: wfTrigger,         value: Set value as true to trigger the workflow rule while inserting record into CRM Potential. By default, this parameter is false.
        ...
        /// </summary>
        /// <param name="PotentialId">Specify unique ID of the record</param>
        /// <param name="Potential">Potential with updated data</param>
        ...
        /// <returns>List of Potentials</returns>
        public List<Potentials> getSearchRecords(string selectColumns, string searchCondition)
        {
            return this.getSearchRecords<List<Potentials>>(module, selectColumns, searchCondition);
        }
        ...
        ///                             key: version            value: (1 -4 Default value: 1)</param>
        /// <returns>List of Potentials</returns>
        public List<Potentials> getSearchRecords(string selectColumns, string searchCondition, Dictionary<string, string> parameters)
        {
            return this.getSearchRecords<List<Potentials>>(module, selectColumns, searchCondition, parameters);
        }
        ...
        /// <returns>List of Potentials</returns>
        public List<Potentials> getSearchRecordsByPDC(string selectColumns, string searchColumn, string searchValue)
        {
            return this.getSearchRecordsByPDC<List<Potentials>>(module, selectColumns, searchColumn, searchValue);
        }
        ...
        ///                             key: version            value: (1 -4 Default value: 1)</param>
        /// <returns>List of Potentials</returns>
        public List<Potentials> getSearchRecordsByPDC(string selectColumns, string searchColumn, string searchValue, Dictionary<string, string> parameters)
        {
            return this.getSearchRecordsByPDC<List<Potentials>>(module, selectColumns, searchColumn, searchValue, parameters);
        }
        ...
        /// Dictionary:                 key: fromIndex, 	    value: (Default value: 1)
        ///                             key: toIndex,           value: (Default value:20 / Maximum value:200)
        ///                             key: newFormat	        value: (1 or 2)	newFormat=1: To exclude fields with "null" values while fetching data from your CRM Potential.</param>
        /// <returns>List of Potentials</returns>
