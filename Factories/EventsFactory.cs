...
namespace ZohoCrmConnector.Factories
{
    public class EventsFactory : RestSharpFactory
    {
        ...
        public bool updateRecords(long EventId, List<Events> listEvents)
        {
            return this.updateRecords(module, EventId, listEvents);
        }

        public bool updateRecords(long EventId, List<Events> listEvents, Dictionary<string, string> parameters)
        {
        ...
        public bool uploadPhoto(long EventId, string filePath)
        {
            return this.uploadPhoto(module, EventId, filePath);
        }

        public bool downloadPhoto(long EventId)
        {
            return this.downloadPhoto(module, EventId);
        }

        public bool deletePhoto(long EventId)
        {
            return this.deletePhoto(module, EventId);
        }
    }
}
