...
namespace ZohoCrmConnector.Factories
{
    public class CasesFactory : RestSharpFactory
    {
        ...
        public bool updateRecords(long CaseId, List<Cases> listCases)
        {
            return this.updateRecords(module, CaseId, listCases);
        }

        public bool updateRecords(long CaseId, List<Cases> listCases, Dictionary<string, string> parameters)
        {
        ...
        public bool uploadPhoto(long CaseId, string filePath)
        {
            return this.uploadPhoto(module, CaseId, filePath);
        }

        public bool downloadPhoto(long CaseId)
        {
            return this.downloadPhoto(module, CaseId);
        }

        public bool deletePhoto(long CaseId)
        {
            return this.deletePhoto(module, CaseId);
        }
    }
}
