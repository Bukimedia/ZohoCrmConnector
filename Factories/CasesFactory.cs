...
namespace ZohoCrmConnector.Factories
{
    public class CasesFactory : RestSharpFactory
    {
        ...
        ///                             key: newFormat	        value: (1 or 2)	newFormat=1: To exclude fields with "null" values while fetching data from your CRM Case.
        ...
        /// </summary>
        /// <param name="CaseId">Specify unique ID of the record</param>
        ...
        /// <param name="CaseId">Specify unique ID of the record</param>
        /// <param name="parameters">
        /// Dictionary:                 key: newFormat	        value: (1 or 2)	newFormat=1: To exclude fields with "null" values while fetching data from your CRM Case.
        ///                             key: version            value: (1 -4 Default value: 1)</param>
        /// <returns></returns>
        ...
        /// </summary>
        /// <param name="listCases">List of Cases, even if it has only one element</param>
        ...
        /// <param name="listCases">List of Cases, even if it has only one element</param>
        /// <param name="parameters">
        /// Dictionary:                 key: wfTrigger,         value: Set value as true to trigger the workflow rule while inserting record into CRM Case. By default, this parameter is false.
        ...
        ///                             key: isApproval,        value: By default, records are inserted directly . To keep the records in approval mode, set value as true.
        ///                             key: newFormat	        value: (1 or 2)	newFormat=1: To exclude fields with "null" values while fetching data from your CRM Case.
        ///                             key: version            value: (1 -4 Default value: 1)</param>
        /// <returns>True if inserted successfully or throws an exception if it could not insert properly</returns>
        ...
        /// </summary>
        /// <param name="CaseId">Specify unique ID of the record</param>
        /// <param name="Case">Case with updated data</param>
        ...
        /// <returns>List of Cases</returns>
        public List<Cases> getSearchRecords(string selectColumns, string searchCondition)
        {
            return this.getSearchRecords<List<Cases>>(module, selectColumns, searchCondition);
        }
        ...
        ///                             key: version            value: (1 -4 Default value: 1)</param>
        /// <returns>List of Cases</returns>
        public List<Cases> getSearchRecords(string selectColumns, string searchCondition, Dictionary<string, string> parameters)
        {
            return this.getSearchRecords<List<Cases>>(module, selectColumns, searchCondition, parameters);
        }
        ...
        /// <returns>List of Cases</returns>
        public List<Cases> getSearchRecordsByPDC(string selectColumns, string searchColumn, string searchValue)
        {
            return this.getSearchRecordsByPDC<List<Cases>>(module, selectColumns, searchColumn, searchValue);
        }
        ...
        ///                             key: version            value: (1 -4 Default value: 1)</param>
        /// <returns>List of Cases</returns>
        public List<Cases> getSearchRecordsByPDC(string selectColumns, string searchColumn, string searchValue, Dictionary<string, string> parameters)
        {
            return this.getSearchRecordsByPDC<List<Cases>>(module, selectColumns, searchColumn, searchValue, parameters);
        }
        ...
        /// Dictionary:                 key: fromIndex, 	    value: (Default value: 1)
        ///                             key: toIndex,           value: (Default value:20 / Maximum value:200)
        ///                             key: newFormat	        value: (1 or 2)	newFormat=1: To exclude fields with "null" values while fetching data from your CRM Case.</param>
        /// <returns>List of Cases</returns>
