...
namespace ZohoCrmConnector.Factories
{
    public class AccountsFactory : RestSharpFactory
    {
        ...
        /// </summary>
        /// <param name="AccountId">Specify unique ID of the record</param>
        ...
        /// </summary>
        /// <param name="listAccounts">List of Accounts, even if it has only one element</param>
        ...
        /// </summary>
        /// <param name="AccountId">Specify unique ID of the record</param>
        /// <param name="Account">Account with updated data</param>
        /// <returns>True if updated successfully or throws an exception if it could not updated properly</returns>
        public bool updateRecords(long AccountId, Accounts Account)
        {
        ...
        ///                             key: version            value: (1 -4 Default value: 1)</param>
        /// <returns>True if updated successfully or throws an exception if it could not updated properly</returns>
        public bool updateRecords(long AccountId, Accounts Account, Dictionary<string, string> parameters)
        {
            List<Accounts> listAccounts = new List<Accounts>();
            listAccounts.Add(Account);
        ...
        /// <returns>List of Accounts</returns>
        public List<Accounts> getSearchRecords(string selectColumns, string searchCondition)
        {
            return this.getSearchRecords<List<Accounts>>(module, selectColumns, searchCondition);
        }
        ...
        ///                             key: version            value: (1 -4 Default value: 1)</param>
        /// <returns>List of Accounts</returns>
        public List<Accounts> getSearchRecords(string selectColumns, string searchCondition, Dictionary<string, string> parameters)
        {
            return this.getSearchRecords<List<Accounts>>(module, selectColumns, searchCondition, parameters);
        }
        ...
        /// <returns>List of Accounts</returns>
        public List<Accounts> getSearchRecordsByPDC(string selectColumns, string searchColumn, string searchValue)
        {
            return this.getSearchRecordsByPDC<List<Accounts>>(module, selectColumns, searchColumn, searchValue);
        }
        ...
        ///                             key: version            value: (1 -4 Default value: 1)</param>
        /// <returns>List of Accounts</returns>
        public List<Accounts> getSearchRecordsByPDC(string selectColumns, string searchColumn, string searchValue, Dictionary<string, string> parameters)
        {
            return this.getSearchRecordsByPDC<List<Accounts>>(module, selectColumns, searchColumn, searchValue, parameters);
        }
