...
namespace ZohoCrmConnector.Factories
{
    public class LeadsFactory : RestSharpFactory
    {
        ...
        ///                             key: newFormat	        value: (1 or 2)	newFormat=1: To exclude fields with "null" values while fetching data from your CRM account.
        ...
        /// </summary>
        /// <param name="LeadId">Specify unique ID of the record</param>
        ...
        /// </summary>
        /// <param name="listLeads">List of Leads, even if it has only one element</param>
        ...
        /// <param name="listLeads">List of Leads, even if it has only one element</param>
        /// <param name="parameters">
        /// Dictionary:                 key: wfTrigger,         value: Set value as true to trigger the workflow rule while inserting record into CRM account. By default, this parameter is false.
        ...
        /// </summary>
        /// <param name="LeadId">Specify unique ID of the record</param>
        /// <param name="Lead">Lead with updated data</param>
        ...
        /// <returns>List of Leads</returns>
        public List<Leads> getSearchRecords(string selectColumns, string searchCondition)
        {
            return this.getSearchRecords<List<Leads>>(module, selectColumns, searchCondition);
        }
        ...
        ///                             key: version            value: (1 -4 Default value: 1)</param>
        /// <returns>List of Leads</returns>
        public List<Leads> getSearchRecords(string selectColumns, string searchCondition, Dictionary<string, string> parameters)
        {
            return this.getSearchRecords<List<Leads>>(module, selectColumns, searchCondition, parameters);
        }
        ...
        /// <returns>List of Leads</returns>
        public List<Leads> getSearchRecordsByPDC(string selectColumns, string searchColumn, string searchValue)
        {
            return this.getSearchRecordsByPDC<List<Leads>>(module, selectColumns, searchColumn, searchValue);
        }
        ...
        ///                             key: version            value: (1 -4 Default value: 1)</param>
        /// <returns>List of Leads</returns>
        public List<Leads> getSearchRecordsByPDC(string selectColumns, string searchColumn, string searchValue, Dictionary<string, string> parameters)
        {
            return this.getSearchRecordsByPDC<List<Leads>>(module, selectColumns, searchColumn, searchValue, parameters);
        }
        ...
        /// </summary>
        /// <param name="LeadId">Specify unique ID of the record</param>
        /// <returns>True if downloaded photo successfully or throws an exception if it could not downloaded photo properly</returns>
        ...
        /// </summary>
        /// <param name="LeadId">Specify unique ID of the record</param>
        /// <returns>True if deleted photo successfully or throws an exception if it could not deleted photo properly</returns>
