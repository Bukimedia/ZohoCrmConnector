...
namespace ZohoCrmConnector.Factories
{
    public class QuotesFactory : RestSharpFactory
    {
        ...
        public bool uploadPhoto(long QuoteId, string filePath)
        {
            return this.uploadPhoto(module, QuoteId, filePath);
        }

        public bool downloadPhoto(long QuoteId)
        {
            return this.downloadPhoto(module, QuoteId);
        }

        public bool deletePhoto(long QuoteId)
        {
            return this.deletePhoto(module, QuoteId);
        }
    }
}
