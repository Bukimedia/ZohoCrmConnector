...
namespace ZohoCrmConnector.Factories
{
    public class ProductsFactory : RestSharpFactory
    {
        ...
        ///                             key: newFormat	        value: (1 or 2)	newFormat=1: To exclude fields with "null" values while fetching data from your CRM Product.
        ...
        /// </summary>
        /// <param name="ProductId">Specify unique ID of the record</param>
        ...
        /// <param name="ProductId">Specify unique ID of the record</param>
        /// <param name="parameters">
        /// Dictionary:                 key: newFormat	        value: (1 or 2)	newFormat=1: To exclude fields with "null" values while fetching data from your CRM Product.
        ///                             key: version            value: (1 -4 Default value: 1)</param>
        /// <returns></returns>
        ...
        /// </summary>
        /// <param name="listProducts">List of Products, even if it has only one element</param>
        ...
        /// <param name="listProducts">List of Products, even if it has only one element</param>
        /// <param name="parameters">
        /// Dictionary:                 key: wfTrigger,         value: Set value as true to trigger the workflow rule while inserting record into CRM Product. By default, this parameter is false.
        ...
        /// <returns>List of Products</returns>
        public List<Products> getSearchRecords(string selectColumns, string searchCondition)
        {
            return this.getSearchRecords<List<Products>>(module, selectColumns, searchCondition);
        }
        ...
        ///                             key: version            value: (1 -4 Default value: 1)</param>
        /// <returns>List of Products</returns>
        public List<Products> getSearchRecords(string selectColumns, string searchCondition, Dictionary<string, string> parameters)
        {
            return this.getSearchRecords<List<Products>>(module, selectColumns, searchCondition, parameters);
        }
        ...
        /// <returns>List of Products</returns>
        public List<Products> getSearchRecordsByPDC(string selectColumns, string searchColumn, string searchValue)
        {
            return this.getSearchRecordsByPDC<List<Products>>(module, selectColumns, searchColumn, searchValue);
        }
        ...
        ///                             key: version            value: (1 -4 Default value: 1)</param>
        /// <returns>List of Products</returns>
        public List<Products> getSearchRecordsByPDC(string selectColumns, string searchColumn, string searchValue, Dictionary<string, string> parameters)
        {
            return this.getSearchRecordsByPDC<List<Products>>(module, selectColumns, searchColumn, searchValue, parameters);
        }
        ...
        /// Dictionary:                 key: fromIndex, 	    value: (Default value: 1)
        ///                             key: toIndex,           value: (Default value:20 / Maximum value:200)
        ///                             key: newFormat	        value: (1 or 2)	newFormat=1: To exclude fields with "null" values while fetching data from your CRM Product.</param>
        /// <returns>List of Products</returns>
