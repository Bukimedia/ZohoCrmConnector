...
namespace ZohoCrmConnector.Factories
{
    public class ProductsFactory : RestSharpFactory
    {
        ...
        public bool updateRecords(long ProductId, List<Products> listProducts)
        {
            return this.updateRecords(module, ProductId, listProducts);
        }

        public bool updateRecords(long ProductId, List<Products> listProducts, Dictionary<string, string> parameters)
        {
        ...
        public bool uploadPhoto(long ProductId, string filePath)
        {
            return this.uploadPhoto(module, ProductId, filePath);
        }

        public bool downloadPhoto(long ProductId)
        {
            return this.downloadPhoto(module, ProductId);
        }

        public bool deletePhoto(long ProductId)
        {
            return this.deletePhoto(module, ProductId);
        }
    }
}
