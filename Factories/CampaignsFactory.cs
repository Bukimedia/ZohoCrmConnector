...
namespace ZohoCrmConnector.Factories
{
    public class CampaignsFactory : RestSharpFactory
    {
        ...
        ///                             key: newFormat	        value: (1 or 2)	newFormat=1: To exclude fields with "null" values while fetching data from your CRM Campaign.
        ...
        /// </summary>
        /// <param name="CampaignId">Specify unique ID of the record</param>
        ...
        /// <param name="CampaignId">Specify unique ID of the record</param>
        /// <param name="parameters">
        /// Dictionary:                 key: newFormat	        value: (1 or 2)	newFormat=1: To exclude fields with "null" values while fetching data from your CRM Campaign.
        ///                             key: version            value: (1 -4 Default value: 1)</param>
        /// <returns></returns>
        ...
        /// </summary>
        /// <param name="listCampaigns">List of Campaigns, even if it has only one element</param>
        ...
        /// <param name="listCampaigns">List of Campaigns, even if it has only one element</param>
        /// <param name="parameters">
        /// Dictionary:                 key: wfTrigger,         value: Set value as true to trigger the workflow rule while inserting record into CRM Campaign. By default, this parameter is false.
        ...
        /// </summary>
        /// <param name="CampaignId">Specify unique ID of the record</param>
        /// <param name="Campaign">Campaign with updated data</param>
        ...
        /// <returns>List of Campaigns</returns>
        public List<Campaigns> getSearchRecords(string selectColumns, string searchCondition)
        {
            return this.getSearchRecords<List<Campaigns>>(module, selectColumns, searchCondition);
        }
        ...
        ///                             key: version            value: (1 -4 Default value: 1)</param>
        /// <returns>List of Campaigns</returns>
        public List<Campaigns> getSearchRecords(string selectColumns, string searchCondition, Dictionary<string, string> parameters)
        {
            return this.getSearchRecords<List<Campaigns>>(module, selectColumns, searchCondition, parameters);
        }
        ...
        /// <returns>List of Campaigns</returns>
        public List<Campaigns> getSearchRecordsByPDC(string selectColumns, string searchColumn, string searchValue)
        {
            return this.getSearchRecordsByPDC<List<Campaigns>>(module, selectColumns, searchColumn, searchValue);
        }
        ...
        ///                             key: version            value: (1 -4 Default value: 1)</param>
        /// <returns>List of Campaigns</returns>
        public List<Campaigns> getSearchRecordsByPDC(string selectColumns, string searchColumn, string searchValue, Dictionary<string, string> parameters)
        {
            return this.getSearchRecordsByPDC<List<Campaigns>>(module, selectColumns, searchColumn, searchValue, parameters);
        }
        ...
        /// Dictionary:                 key: fromIndex, 	    value: (Default value: 1)
        ///                             key: toIndex,           value: (Default value:20 / Maximum value:200)
        ///                             key: newFormat	        value: (1 or 2)	newFormat=1: To exclude fields with "null" values while fetching data from your CRM Campaign.</param>
        /// <returns>List of Campaigns</returns>
