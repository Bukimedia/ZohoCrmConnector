...
namespace ZohoCrmConnector.Factories
{
    public class TasksFactory : RestSharpFactory
    {
        ...
        public bool uploadPhoto(long TaskId, string filePath)
        {
            return this.uploadPhoto(module, TaskId, filePath);
        }

        public bool downloadPhoto(long TaskId)
        {
            return this.downloadPhoto(module, TaskId);
        }

        public bool deletePhoto(long TaskId)
        {
            return this.deletePhoto(module, TaskId);
        }
    }
}
