...
namespace ZohoCrmConnector.Factories
{
    public class CallsFactory : RestSharpFactory
    {
        ...
        public bool uploadPhoto(long CallId, string filePath)
        {
            return this.uploadPhoto(module, CallId, filePath);
        }

        public bool downloadPhoto(long CallId)
        {
            return this.downloadPhoto(module, CallId);
        }

        public bool deletePhoto(long CallId)
        {
            return this.deletePhoto(module, CallId);
        }
    }
}
