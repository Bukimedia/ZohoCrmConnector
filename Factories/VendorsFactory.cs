...
namespace ZohoCrmConnector.Factories
{
    public class VendorsFactory : RestSharpFactory
    {
        ...
        ///                             key: newFormat	        value: (1 or 2)	newFormat=1: To exclude fields with "null" values while fetching data from your CRM Vendor.
        ...
        /// </summary>
        /// <param name="VendorId">Specify unique ID of the record</param>
        ...
        /// <param name="VendorId">Specify unique ID of the record</param>
        /// <param name="parameters">
        /// Dictionary:                 key: newFormat	        value: (1 or 2)	newFormat=1: To exclude fields with "null" values while fetching data from your CRM Vendor.
        ///                             key: version            value: (1 -4 Default value: 1)</param>
        /// <returns></returns>
        ...
        /// </summary>
        /// <param name="listVendors">List of Vendors, even if it has only one element</param>
        ...
        /// <param name="listVendors">List of Vendors, even if it has only one element</param>
        /// <param name="parameters">
        /// Dictionary:                 key: wfTrigger,         value: Set value as true to trigger the workflow rule while inserting record into CRM Vendor. By default, this parameter is false.
        ...
        /// </summary>
        /// <param name="VendorId">Specify unique ID of the record</param>
        /// <param name="Vendor">Vendor with updated data</param>
        /// <returns>True if updated successfully or throws an exception if it could not updated properly</returns>
        public bool updateRecords(long VendorId, Vendors Vendor)
        {
        ...
        ///                             key: version            value: (1 -4 Default value: 1)</param>
        /// <returns>True if updated successfully or throws an exception if it could not updated properly</returns>
        public bool updateRecords(long VendorId, Vendors Vendor, Dictionary<string, string> parameters)
        {
            List<Vendors> listVendors = new List<Vendors>();
            listVendors.Add(Vendor);
        ...
        /// <returns>List of Vendors</returns>
        public List<Vendors> getSearchRecords(string selectColumns, string searchCondition)
        {
            return this.getSearchRecords<List<Vendors>>(module, selectColumns, searchCondition);
        }
        ...
        ///                             key: version            value: (1 -4 Default value: 1)</param>
        /// <returns>List of Vendors</returns>
        public List<Vendors> getSearchRecords(string selectColumns, string searchCondition, Dictionary<string, string> parameters)
        {
            return this.getSearchRecords<List<Vendors>>(module, selectColumns, searchCondition, parameters);
        }
        ...
        /// <returns>List of Vendors</returns>
        public List<Vendors> getSearchRecordsByPDC(string selectColumns, string searchColumn, string searchValue)
        {
            return this.getSearchRecordsByPDC<List<Vendors>>(module, selectColumns, searchColumn, searchValue);
        }
        ...
        ///                             key: version            value: (1 -4 Default value: 1)</param>
        /// <returns>List of Vendors</returns>
        public List<Vendors> getSearchRecordsByPDC(string selectColumns, string searchColumn, string searchValue, Dictionary<string, string> parameters)
        {
            return this.getSearchRecordsByPDC<List<Vendors>>(module, selectColumns, searchColumn, searchValue, parameters);
        }
        ...
        /// Dictionary:                 key: fromIndex, 	    value: (Default value: 1)
        ///                             key: toIndex,           value: (Default value:20 / Maximum value:200)
        ///                             key: newFormat	        value: (1 or 2)	newFormat=1: To exclude fields with "null" values while fetching data from your CRM Vendor.</param>
        /// <returns>List of Vendors</returns>
