...
namespace ZohoCrmConnector.Factories
{
    public class SalesOrdersFactory : RestSharpFactory
    {
        ...
        /// </summary>
        /// <returns>List of SalesOrders</returns>
        ...
        ///                             key: newFormat	        value: (1 or 2)	newFormat=1: To exclude fields with "null" values while fetching data from your CRM SalesOrder.
        ...
        /// </summary>
        /// <param name="SalesOrderId">Specify unique ID of the record</param>
        ...
        /// <param name="SalesOrderId">Specify unique ID of the record</param>
        /// <param name="parameters">
        /// Dictionary:                 key: newFormat	        value: (1 or 2)	newFormat=1: To exclude fields with "null" values while fetching data from your CRM SalesOrder.
        ///                             key: version            value: (1 -4 Default value: 1)</param>
        /// <returns></returns>
        ...
        /// </summary>
        /// <param name="listSalesOrders">List of SalesOrders, even if it has only one element</param>
        ...
        /// <param name="listSalesOrders">List of SalesOrders, even if it has only one element</param>
        /// <param name="parameters">
        /// Dictionary:                 key: wfTrigger,         value: Set value as true to trigger the workflow rule while inserting record into CRM SalesOrder. By default, this parameter is false.
        ...
        /// </summary>
        /// <param name="SalesOrderId">Specify unique ID of the record</param>
        /// <param name="SalesOrder">SalesOrder with updated data</param>
        /// <returns>True if updated successfully or throws an exception if it could not updated properly</returns>
        public bool updateRecords(long SalesOrderId, SalesOrders SalesOrder)
        {
            List<SalesOrders> listSalesOrders = new List<SalesOrders>();
        ...
        ///                             key: version            value: (1 -4 Default value: 1)</param>
        /// <returns>True if updated successfully or throws an exception if it could not updated properly</returns>
        public bool updateRecords(long SalesOrderId, SalesOrders SalesOrder, Dictionary<string, string> parameters)
        {
            List<SalesOrders> listSalesOrders = new List<SalesOrders>();
            listSalesOrders.Add(SalesOrder);
        ...
        /// <returns>List of SalesOrders</returns>
        public List<SalesOrders> getSearchRecords(string selectColumns, string searchCondition)
        {
            return this.getSearchRecords<List<SalesOrders>>(module, selectColumns, searchCondition);
        }
        ...
        ///                             key: version            value: (1 -4 Default value: 1)</param>
        /// <returns>List of SalesOrders</returns>
        public List<SalesOrders> getSearchRecords(string selectColumns, string searchCondition, Dictionary<string, string> parameters)
        {
            return this.getSearchRecords<List<SalesOrders>>(module, selectColumns, searchCondition, parameters);
        }
        ...
        /// <returns>List of SalesOrders</returns>
        public List<SalesOrders> getSearchRecordsByPDC(string selectColumns, string searchColumn, string searchValue)
        {
            return this.getSearchRecordsByPDC<List<SalesOrders>>(module, selectColumns, searchColumn, searchValue);
        }
        ...
        ///                             key: version            value: (1 -4 Default value: 1)</param>
        /// <returns>List of SalesOrders</returns>
        public List<SalesOrders> getSearchRecordsByPDC(string selectColumns, string searchColumn, string searchValue, Dictionary<string, string> parameters)
        {
            return this.getSearchRecordsByPDC<List<SalesOrders>>(module, selectColumns, searchColumn, searchValue, parameters);
        }
        ...
        /// Dictionary:                 key: fromIndex, 	    value: (Default value: 1)
        ///                             key: toIndex,           value: (Default value:20 / Maximum value:200)
        ///                             key: newFormat	        value: (1 or 2)	newFormat=1: To exclude fields with "null" values while fetching data from your CRM SalesOrder.</param>
        /// <returns>List of SalesOrders</returns>
