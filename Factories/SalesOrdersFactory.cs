...
namespace ZohoCrmConnector.Factories
{
    public class SalesOrdersFactory : RestSharpFactory
    {
        ...
        public bool uploadPhoto(long SalesOrderId, string filePath)
        {
            return this.uploadPhoto(module, SalesOrderId, filePath);
        }

        public bool downloadPhoto(long SalesOrderId)
        {
            return this.downloadPhoto(module, SalesOrderId);
        }

        public bool deletePhoto(long SalesOrderId)
        {
            return this.deletePhoto(module, SalesOrderId);
        }
    }
}
